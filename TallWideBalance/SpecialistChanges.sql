...
VALUES
	('BUILDING_RESEARCH_LAB',				'YIELD_FOOD',			1),
	('BUILDING_BROADCAST_CENTER',			'YIELD_FOOD',			1),
	('BUILDING_FILM_STUDIO',				'YIELD_FOOD',			1),
	('BUILDING_CATHEDRAL',					'YIELD_FOOD',			1),
	('BUILDING_GURDWARA',					'YIELD_FOOD',			1),
	('BUILDING_MEETING_HOUSE',				'YIELD_FOOD',			1),
	('BUILDING_MOSQUE',						'YIELD_FOOD',			1),
	('BUILDING_PAGODA',						'YIELD_FOOD',			1),
	('BUILDING_SYNAGOGUE',					'YIELD_FOOD',			1),
	('BUILDING_WAT',						'YIELD_FOOD',			1),
	('BUILDING_STUPA',						'YIELD_FOOD',			1),
	('BUILDING_DAR_E_MEHR',					'YIELD_FOOD',			1),
	('BUILDING_STOCK_EXCHANGE',				'YIELD_FOOD',			1),
	('BUILDING_COAL_POWER_PLANT',			'YIELD_FOOD',			1),
	('BUILDING_FOSSIL_FUEL_POWER_PLANT',	'YIELD_FOOD',			1),
	('BUILDING_POWER_PLANT',				'YIELD_FOOD',			1),
